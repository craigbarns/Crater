...
<div style="margin: 15px 30px; padding: 10px; border: 0.5px solid #EAF1FB; page-break-inside: avoid; background-color: #FBFDFF;">
    ...
    <table width="100%" cellspacing="0" border="0" style="margin-bottom: 10px;">
        <tr>
            <td style="font-size: 11px; font-weight: bold; color: #717182; padding-bottom: 4px;" colspan="4">
                COMPANY INFORMATION
            </td>
        </tr>
        @if ($company->business_registration_number)
        <tr>
            <td style="font-size: 10px; color: #717182; width: 25%;">Business Reg. No.:</td>
            <td style="font-size: 10px; color: #040405; width: 25%;">{{ $company->business_registration_number }}</td>
            @if ($company->tax_id)
            <td style="font-size: 10px; color: #717182; width: 25%;">Tax ID:</td>
        ...
        <tr>
            <td style="font-size: 10px; color: #717182;">IBAN:</td>
    ...
    <table width="100%" cellspacing="0" border="0" style="margin-top: 6px; border-top: 0.5px solid #EAF1FB; padding-top: 6px;">
        ...
        <tr>
            <td style="font-size: 10px; color: #717182; width: 25%;">Incoterm:</td>
            <td style="font-size: 10px; color: #040405; font-weight: bold; width: 25%;">{{ $estimate->incoterm }}</td>
            @if ($estimate->country_of_origin)
            <td style="font-size: 10px; color: #717182; width: 25%;">Country of Origin:</td>
        ...
        <tr>
            <td style="font-size: 10px; color: #717182;">Payment Terms:</td>
            <td style="font-size: 10px; color: #040405;" colspan="3">{{ $estimate->payment_terms }}</td>
        </tr>
        @endif
        @if ($estimate->delivery_lead_time)
        <tr>
            <td style="font-size: 10px; color: #717182;">Delivery Lead Time:</td>
        ...
        <tr>
            ...
            <td style="font-size: 10px; color: #717182;">Port of Loading:</td>
            <td style="font-size: 10px; color: #040405;">{{ $estimate->shipping_port }}</td>
            @endif
            @if ($estimate->destination_port)
            <td style="font-size: 10px; color: #717182;">Port of Destination:</td>
        ...
        <tr>
            <td style="font-size: 10px; color: #717182;">Transport Mode:</td>
